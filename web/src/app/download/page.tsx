  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 space-y-12">
        ...
        {loading && (
          <p className="text-[11px] text-text-dim text-center">Loading releases...</p>
        )}
        ...
        {error && (
          <div className="text-center space-y-4">
            ...
            <a
              ...
              className="font-pixel text-[12px] px-6 py-3 border-2 bg-gold text-bg-darkest border-gold-dark shadow-pixel-gold hover:brightness-110 active:shadow-pixel-pressed active:translate-x-[2px] active:translate-y-[2px] cursor-pointer inline-block transition-all"
            >
              VIEW ON GITHUB
            </a>
          </div>
        ...
        {latest && (
          <PixelBorder highlight className="p-8 border-gold/50">
            ...
            {/* Changelog excerpt */}
            {latest.body && (
              <pre className="text-[10px] text-text-dim bg-bg-darkest border-2 border-border-dark p-4 mb-6 whitespace-pre-wrap leading-relaxed max-h-40 overflow-y-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              {(() => {
                ...
                return win ? (
                  <a
                    ...
                    className="font-pixel text-[12px] px-6 py-3 border-2 bg-gold text-bg-darkest border-gold-dark shadow-pixel-gold hover:brightness-110 active:shadow-pixel-pressed active:translate-x-[2px] active:translate-y-[2px] cursor-pointer inline-block text-center transition-all"
                  >
                    DOWNLOAD FOR WINDOWS
                    <span className="block text-[11px] text-bg-darkest/70 mt-1">
              ...
              {/* macOS placeholder */}
              <span className="font-pixel text-[12px] px-6 py-3 border-2 bg-transparent text-text-dim border-border-light shadow-pixel cursor-default inline-block text-center opacity-60">
                macOS COMING SOON
              </span>
            </div>
          </PixelBorder>
          ...
          <section>
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        <span className="text-[12px] text-text-bright">
                          {release.tag_name}
                        </span>
                        {release.prerelease && (
                          <span className="text-[11px] text-orange border border-orange/40 px-1.5 py-0.5">
                            PRE
                          </span>
                        )}
                      </div>
                    ...
                    <div className="shrink-0">
                      {hasPro ? (
                        win ? (
                          <a
                            href={win.browser_download_url}
                            className="font-pixel text-[11px] px-4 py-2 border-2 bg-transparent text-text-bright border-border-light shadow-pixel hover:border-gold hover:text-gold cursor-pointer inline-block text-center transition-all"
                          >
                            DOWNLOAD
                          </a>
                        ) : (
                        ...
                        <div className="relative inline-block">
                          <span className="font-pixel text-[11px] px-4 py-2 border-2 bg-transparent text-text-dim border-border-dark shadow-pixel cursor-default inline-block text-center opacity-50">
                            DOWNLOAD
                          </span>
                          <span className="absolute -top-2 -right-2 text-[11px] text-bg-darkest bg-gold px-1.5 py-0.5">
                            PRO
                          </span>
                        </div>
                      )}
            ...
            {!hasPro && (
              <p className="text-center mt-6">
                <a
                  href="/subscribe"
                  className="text-[11px] text-gold hover:underline transition-colors"
                >

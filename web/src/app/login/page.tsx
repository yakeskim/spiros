      ...
      <main className="max-w-md mx-auto px-4 py-16">
        ...
        {!forgotMode ? (
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex justify-between items-center pt-2">
              <button
                ...
                className="text-[10px] text-text-dim hover:text-gold transition-colors cursor-pointer"
              >
                Forgot password?
              </button>
              <a href="/signup" className="text-[10px] text-gold hover:underline">
                Create account
              </a>
            </div>
          </form>
          ...
          <div className="text-center">
            <p className="text-[11px] text-green-400 mb-4">Check your email for a reset link.</p>
            <button
              type="button"

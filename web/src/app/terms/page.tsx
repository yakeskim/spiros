    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-16">
        ...
        <section className="mb-10">
          <h2 className="text-text-bright text-[13px] mb-4">1. Acceptance of Terms</h2>
        ...
        <section className="mb-10">
          <h2 className="text-text-bright text-[13px] mb-4">2. License</h2>
          <div className="text-[11px] text-text-dim leading-relaxed space-y-3">
        ...
        <section className="mb-10">
          <h2 className="text-text-bright text-[13px] mb-4">3. Acceptable Use</h2>
          <div className="text-[11px] text-text-dim leading-relaxed space-y-3">
        ...
        <section className="mb-10">
          <h2 className="text-text-bright text-[13px] mb-4">4. Privacy</h2>
          <div className="text-[11px] text-text-dim leading-relaxed space-y-3">
        ...
        <section className="mb-10">
          <h2 className="text-text-bright text-[13px] mb-4">5. Disclaimers</h2>
          <div className="text-[11px] text-text-dim leading-relaxed space-y-3">
        ...
        <section className="mb-10">
          <h2 className="text-text-bright text-[13px] mb-4">6. Limitation of Liability</h2>
          <div className="text-[11px] text-text-dim leading-relaxed space-y-3">
        ...
        <section className="mb-10">
          <h2 className="text-text-bright text-[13px] mb-4">7. Changes to Terms</h2>
          <div className="text-[11px] text-text-dim leading-relaxed space-y-3">

      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mt-8">
            <a href="/download" className="text-[9px] text-text-bright border-2 border-border-light px-4 py-2 flex items-center gap-2 hover:border-gold hover:text-gold transition-colors">
        ...
        <MockupWindow>
          <div className="flex flex-col items-center justify-center py-10 gap-5">
            ...
            {/* Loading text */}
            <div className="text-[9px] text-text-dim animate-pixel-blink">
              LOADING...
            </div>
          </div>
        </MockupWindow>

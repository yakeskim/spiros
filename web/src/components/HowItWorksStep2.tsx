      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <MockupWindow sidebar activeNav={0}>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                >
                  ...
                  <div className="text-[11px] text-text-dim mt-1">{s.label}</div>
                </div>
              ))}
            </div>
            ...
            {/* Timeline bar */}
            <div>
              <div className="text-[11px] text-text-dim mb-1">TODAY&apos;S TIMELINE</div>
            ...
            {/* Top apps */}
            <div>
              <div className="text-[11px] text-text-dim mb-2">TOP APPS</div>
              <div className="space-y-2">
                {[
                  ...
                  <div key={app.name} className="flex items-center gap-2">
                    <span className="text-[11px] text-text-dim w-12 shrink-0">
                      {app.name}
                    </span>
                    ...
                    <span className="text-[10px] text-text-dim w-10 text-right shrink-0">
                      {app.dur}
                    </span>
                  </div>
                ))}

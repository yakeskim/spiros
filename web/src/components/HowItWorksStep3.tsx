        ...
        <MockupWindow sidebar activeNav={2}>
          <div className="space-y-4">
            ...
            <div className="border-2 border-gold bg-gold/5 text-center py-2">
              <span className="text-[11px] text-gold animate-pixel-blink">
                &#9733; LEVEL UP! &#9733;
              </span>
            </div>
            ...
            {/* Achievement grid */}
            <div>
              <div className="text-[11px] text-text-dim mb-2">ACHIEVEMENTS</div>
              <div className="grid grid-cols-2 gap-2">
                {/* Unlocked */}
                <div className="border-2 border-gold bg-gold/5 p-2 text-center">
                  <div className="text-lg">&#9876;</div>
                  <div className="text-[11px] text-gold mt-1">First Blood</div>
                  <div className="text-[10px] text-green mt-0.5">&#10003; Unlocked</div>
                </div>
                <div className="border-2 border-gold bg-gold/5 p-2 text-center">
                  <div className="text-lg">&#9733;</div>
                  <div className="text-[11px] text-gold mt-1">Marathon</div>
                  <div className="text-[10px] text-green mt-0.5">&#10003; Unlocked</div>
                </div>
                {/* Locked */}
                <div className="border-2 border-border-dark bg-bg-dark/50 p-2 text-center opacity-50">
                  ...
                  <div className="text-[10px] text-text-dim mt-0.5">Locked</div>
                </div>
                <div className="border-2 border-border-dark bg-bg-dark/50 p-2 text-center opacity-50">
                  <div className="text-lg text-text-dim">?</div>
                  <div className="text-[11px] text-text-dim mt-1">???</div>
            ...
            {/* Mini leaderboard */}
            <div>
              <div className="text-[11px] text-text-dim mb-2">LEADERBOARD</div>
              <div className="border border-border-dark">
                {[
                  ...
                  <div
                    key={row.rank}
                    className={`flex items-center justify-between px-2 py-1.5 text-[11px] border-b border-border-dark last:border-b-0 ${
                      row.highlight
